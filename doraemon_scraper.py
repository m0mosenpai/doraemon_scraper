...
while True:
	try:
		...
		for link in soup.find_all('img'):
			...
			err = soup.find_all('div', attrs = {"class": "warn"})
			if "There is no selected page!" in err:
				print("That's all of it!")
				exit()
			...
			if 'mangas' in img_url:
				...
				img_name = os.path.join('c:/Users/sarth/Documents/Mangas/ドラえもん', img_name) 
				if not os.path.exists('c:/Users/sarth/Documents/Mangas/ドラえもん'):
					os.makedirs('c:/Users/sarth/Documents/Mangas/ドラえもん')
